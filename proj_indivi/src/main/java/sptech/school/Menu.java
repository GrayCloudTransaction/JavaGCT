                ...
                while (true) {
                    ...
                    if (!componentes.isEmpty()) {
                        ...
                        for (int i = 0; i < 10; i++) {
                            ...
                            System.out.println( "captura " + i + " Feita CPU:" +
                        ...
                        System.out.println("Dados cadastrados, passando lista de processos!");
                        for (Processo processo: lucas.getGrupoDeProcessos().getProcessos()) {
